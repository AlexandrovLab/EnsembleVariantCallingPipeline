...
~/EnsembleVariantCallingPipeline/align_template.sh $email $sample $tumor $normal $ref $path $out $type
~/EnsembleVariantCallingPipeline/targetInterval_template.sh $email $sample $ref $out ${known_indel_list}
~/EnsembleVariantCallingPipeline/refine_template.sh $email $sample $ref $out ${known_indel_list} ${base_recalibration_list}
