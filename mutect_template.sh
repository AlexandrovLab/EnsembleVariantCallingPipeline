...
mutect_pileupsum="gatk GetPileupSummaries --java-options \"-Xmx\$(free -h| grep Mem | awk '{print \$7}')\" -I ${out}/${sample}/${sample}_tumor_final.bam -V $dbSNP -L $dbSNP -O ${sample}_getpileupsummaries.table"
